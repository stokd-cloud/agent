# Upstream architecture and limitations

For the active Stokd runtime, read [stokd-agent.md](stokd-agent.md). This file
describes the retained upstream Cordis plugin and shared renderer.
